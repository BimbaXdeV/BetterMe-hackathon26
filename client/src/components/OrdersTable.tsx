    ...
    <div className="space-y-4">
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl overflow-hidden shadow-2xl">
        <div className="flex items-center gap-2 px-6 py-4 border-b border-zinc-800 bg-zinc-900/80">
          ...
          <h2 className="text-sm font-semibold text-zinc-300 tracking-wide uppercase">Реєстр замовлень</h2>
          <span className="ml-auto text-[10px] font-mono text-zinc-500 uppercase">Знайдено: {totalCount}</span>
        </div>
